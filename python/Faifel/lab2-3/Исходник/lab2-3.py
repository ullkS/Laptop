...
def evaluate_expression():
    ...
    try:
        # Заменяем '0' и '1' на 'False' и 'True' только если в выражении есть буквы
        if any(c.isalpha() for c in logical_expression):
            ...
            # Если в выражении нет букв, обрабатываем его как числовое выражение
            result = eval(logical_expression)
            overall_result = "Истинно" if result else "Ложно"
            result_text.set(f"Результат: {overall_result}")
